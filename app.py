...
if not selected_cities:
    ...
    for city in selected_cities:
        ...
        with tab_trend:
            ...
            month_starts = calendar_df[calendar_df["date"].dt.day == 1]
            month_names = month_starts["date"].dt.strftime("%b").unique()
            month_start_weeks = month_starts["week"].unique()
            ...
            for idx, month_name in enumerate(month_names):
                week_num = month_start_weeks[idx]
                annotations.append(
        ...
        if city_coords_data and not map_grouped_data.empty:
            ...
            if not latlong_map_df.empty:
                ...
                if not map_merged_df.empty:
                    ...
                    scatter_map_layout_args['mapbox_style'] = "c streamers
